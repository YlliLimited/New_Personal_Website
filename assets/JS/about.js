...
if(cursor === insta) {
  cursorPage.style.backgroundImage = "url(/assets/images/instagramA.svg)";
} else if(cursor === facebook) {
  cursorPage.style.backgroundImage = "url(/assets/images/facebookA.svg)";
} else if(cursor === vsco) {
  cursorPage.style.backgroundImage = "url(/assets/images/vscoA.svg)";
} else if (cursor === "none") {
